...
const ECOSYSTEM = [
  {
    icon: '📊',
    name: 'StoicCRM Growth',
    tagline: 'AI-Powered Sales Command Center',
    ...
    url: 'https://stoicagentos.com/dashboard',
    badge: 'Live',
    gradient: 'linear-gradient(135deg, rgba(155,89,255,0.15), rgba(77,124,255,0.08))',
    border: 'rgba(155,89,255,0.25)',
  },
  {
    icon: '🧠',
    name: 'Command Center',
    tagline: 'Second Brain for Agent Fleets',
    desc: '23 agents, 14 workspaces, knowledge graph, persistent memory engine. The orchestration hub that connects everything.',
    url: 'https://stoicagentos.com/dashboard',
    badge: 'Live',
    gradient: 'linear-gradient(135deg, rgba(0,212,255,0.15), rgba(0,230,138,0.08))',
    border: 'rgba(0,212,255,0.25)',
  },
  {
    icon: '🎬',
    name: 'Fetok Autoposter',
    tagline: 'Cinematic Content Automation',
    desc: 'Autonomous TikTok pipeline: FFmpeg rendering + TTS narration + OBS streaming. 100K+ views generated by AI agents.',
    url: 'https://github.com/benjaminkernbaum-ux',
    badge: 'Open Source',
    gradient: 'linear-gradient(135deg, rgba(255,107,157,0.15), rgba(255,159,67,0.08))',
    ...
    <div className="landing">
      ...
      <section className="section" id="ecosystem">
        <div className="container section-center">
          ...
          <h2 className="section-title">Built on AgentOS. Deployed on Vercel.</h2>
          <p className="section-sub">
