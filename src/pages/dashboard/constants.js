...
export const CMD_ITEMS = [
  ...
  { id: 'chat',          icon: '💬', name: 'Go to Chat',          desc: 'Chat with your agents',            tab: 'chat' },
  { id: 'inbox',         icon: '📬', name: 'Go to Inbox',         desc: 'Agent messages and notifications', tab: 'inbox' },
  ...
  { id: 'templates',     icon: '📋', name: 'Go to Templates',     desc: 'Agent template gallery',           tab: 'templates' },
  { id: 'integrations',  icon: '🔌', name: 'Go to Integrations',  desc: 'Connect tools and services',       tab: 'integrations' },
  { id: 'skills',        icon: '🧩', name: 'Go to Skills',        desc: 'Skills library and catalog',       tab: 'skills' },
